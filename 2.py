...
class wi(QWidget):
    ...
    def initfilelabel(self):
        ...
        self.urllabel = QLabel('urlInfo')
        self.dirlabel = QLabel('dirInfo')
        ...
        self.qfl.addWidget(self.dirlabel)
        self.qfl.addRow(self.urllabel, self.UrlInfo)
        self.qfl.addRow(self.dirlabel, self.DirInfo)
